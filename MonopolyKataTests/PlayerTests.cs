...
namespace MonopolyKataTests
{
    ...
    public class PlayerTests
    {
        ...
        {
            var player = PlayerServices.Create(NameConstants.Horse, balance: new Money(201));
        ...
        {
            var player = PlayerServices.Create(NameConstants.Horse, balance: new Money(200));
            var request = new Money(200);
        ...
        {
            var player = PlayerServices.Create(NameConstants.Horse, balance: new Money(199));
            var request = new Money(200);
        ...
        {
            var player = PlayerServices.Create(NameConstants.Horse, balance: new Money(400));
