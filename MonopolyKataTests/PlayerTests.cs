...
namespace MonopolyKataTests
{
    ...
    public class PlayerTests
    {
        ...
        {
            var player = PlayerServices.Create("horse", balance: 201);
        ...
        {
            var player = PlayerServices.Create("horse", balance: 200);
            var request = new Money(200);
        ...
        {
            var player = PlayerServices.Create("horse", balance: 199);
            var request = new Money(200);
        ...
        {
            var player = PlayerServices.Create("horse", balance: 400);
